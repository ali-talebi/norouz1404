    ...
    for iter_flat in total_flat_content:
                ...
                for iteration in range(5):
                    ...
                    params_health.append(
                        [intercept_0, coef1, coef2, coef3, coef4, coef5, coef6, R2, locate, 0, iter_alpha, iter_flat,
                         total_error_health, R2_adj, stat, p_value, dw_statistic])  ## added total_error_health
                    ...
                    params_health_t.append(
                        [intercept_0, coef1, coef2, coef3, coef4, coef5, coef6, R2, locate, 1, iter_alpha, iter_flat,
                         total_error_health_t, R2_adj, stat, p_value, dw_statistic])  ## add total_error_health_t
                    total_change = [1, 1]
                    related_x *= total_change[np.random.randint(0, 2)]
                    related_y *= total_change[np.random.randint(0, 2)]
                    related_z *= total_change[np.random.randint(0, 2)]
                    ...
                    params_fault.append(
                        [intercept_0, coef1, coef2, coef3, coef4, coef5, coef6, R2, locate, 1, iter_alpha, iter_flat,
                         total_error_fault, R2_adj, stat, p_value, dw_statistic])  ## added total_error_fault
                    total_change = [1, 1]
                    related_x *= total_change[np.random.randint(0, 2)]
                    related_y *= total_change[np.random.randint(0, 2)]
                    related_z *= total_change[np.random.randint(0, 2)]
                    ...
                    params_fault_t.append(
                        [intercept_0, coef1, coef2, coef3, coef4, coef5, coef6, R2, locate, 1, iter_alpha, iter_flat,
                         total_error_fault_t, R2_adj, stat, p_value, dw_statistic])  ## added total_error_fault_t
                    total_change = [1, 1]
                    related_x *= total_change[np.random.randint(0, 2)]
                    related_y *= total_change[np.random.randint(0, 2)]
                    related_z *= total_change[np.random.randint(0, 2)]
        ...
        df_params_health_t = pd.DataFrame(
            {'bias': params_health_t[:, 0], 'betha_0': params_health_t[:, 1], 'betha_1': params_health_t[:, 2],
             ...
             'p_value_error': params_health_t[:, 15], 'DW': params_health_t[:, 16]})
        ...
        df_params_fault_t = pd.DataFrame(
            {'bias': params_fault_t[:, 0], 'betha_0': params_fault_t[:, 1], 'betha_1': params_fault_t[:, 2],
             ...
             'p_value_error': params_fault_t[:, 15], 'DW': params_fault_t[:, 16]})
        ...
        df_Data = concat_2_df_health_fault[
            (concat_2_df_health_fault["p_value_error"] > 0.01) & (concat_2_df_health_fault["DW"] > 1) & (concat_2_df_health_fault["DW"] < 3)]
        df_Data.reset_index(inplace=True)
        df_Data["SST"] = concat_2_df_health_fault["SSE"] / (1 - concat_2_df_health_fault["R2"])
        ...
        df_Data.to_csv(f'{store_path}/{iter_alpha}-{iter_flat}.csv' , index = False )
        del df_Data
        del concat_2_df_health_fault
        sleep(5)
